...
(function(window, document) {
   ...
   var SoundMultiSample = function(src, count, loop) {
      this.elements = [];
   ...
   Sound.load = function(name, src, loop, samples) {
      Sounds[name] = new SoundMultiSample(src, samples || 1, loop);
      return Sounds[name];
   };
